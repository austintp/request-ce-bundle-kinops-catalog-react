...
export const Form =
  ({ form, category, submissionId, submissionLabel, match, handleCreated, handleCompleted }) =>
    <div>
      <NavHeader breadcrumbs={buildBreadcrumbs(form, category, submissionLabel, match)} />
